...
--
-- Host: localhost:3306
-- Generation Time: Dec 10, 2014 at 05:07 AM
...
(1, 'connorMac', '$2y$12$dbI1EY8/akR9svuj1MK/9OqcNI3HRxa/JeXvpuoFc.z7P6BNQVXHy');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2241 ;
...
`TrackId` int(11) NOT NULL,
  ...
  `UnitPrice` decimal(10,2) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3504 ;
...
(1, 'For Those About To Rock (We Salute You) MySQL', 1, 1, 1, 'Angus Young, Malcolm Young, Brian Johnson', 343719, 11170334, 0.99),
...
--
ALTER TABLE `album`
 ADD PRIMARY KEY (`AlbumId`), ADD KEY `IFK_AlbumArtistId` (`ArtistId`);
...
ALTER TABLE `customer`
 ADD PRIMARY KEY (`CustomerId`), ADD KEY `IFK_CustomerSupportRepId` (`SupportRepId`);

--
-- Indexes for table `employee`
--
ALTER TABLE `employee`
 ADD PRIMARY KEY (`EmployeeId`), ADD KEY `IFK_EmployeeReportsTo` (`ReportsTo`);
...
--
ALTER TABLE `invoice`
 ADD PRIMARY KEY (`InvoiceId`), ADD KEY `IFK_InvoiceCustomerId` (`CustomerId`);

--
-- Indexes for table `invoiceline`
--
ALTER TABLE `invoiceline`
 ADD PRIMARY KEY (`InvoiceLineId`), ADD KEY `IFK_InvoiceLineInvoiceId` (`InvoiceId`), ADD KEY `IFK_InvoiceLineTrackId` (`TrackId`);
...
ALTER TABLE `playlisttrack`
 ADD PRIMARY KEY (`PlaylistId`,`TrackId`), ADD KEY `IFK_PlaylistTrackTrackId` (`TrackId`);

--
-- Indexes for table `track`
--
ALTER TABLE `track`
 ADD PRIMARY KEY (`TrackId`), ADD KEY `IFK_TrackAlbumId` (`AlbumId`), ADD KEY `IFK_TrackGenreId` (`GenreId`), ADD KEY `IFK_TrackMediaTypeId` (`MediaTypeId`);
